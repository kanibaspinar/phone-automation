...
PLATFORM_BOTH = 'both'
VALID_PLATFORMS = {PLATFORM_INSTAGRAM, PLATFORM_TIKTOK, PLATFORM_BOTH}
...
class Device(db.Model):
    ...
    # Platform assignment: 'instagram', 'tiktok', or 'both'
    platform = db.Column(db.String(16), default=PLATFORM_INSTAGRAM, nullable=False)
    ...
    def __init__(self, device_id, device_name=None, status='disconnected', assigned_to=None,
        ...
        self.metrics = {}
        self.platform = platform if platform in VALID_PLATFORMS else PLATFORM_INSTAGRAM
